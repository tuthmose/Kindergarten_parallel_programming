...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__swigmc

#else
#  define SWIG_init    init_swigmc

#endif
#define SWIG_name    "_swigmc"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_swigpi(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:swigpi",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  result = (double)swigpi(arg1,arg2,arg3,arg4);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"swigpi", _wrap_swigpi, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
